...
//    }
//
//    size_t expPos = tempStr.find("E"); // find position of 'E' char (e.g. 2)
//    if (expPos < 0) {
...
//        exp *= -1;
//    }
//    size_t numLength = tempStr.size() - expStr.size() - 1; // length of numbers substring
//
//    // check sign
...
//    for (size_t i = numLength; i <= (-exp); i++) {
//        result += '0';
//        if (i == numLength) {
//            result += '.';
//            decPtAdded = true;

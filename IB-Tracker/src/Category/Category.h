...
const int IDC_CATEGORYCONTROL_BLUE   = 140;
const int IDC_CATEGORYCONTROL_PURPLE = 141;
const int IDC_CATEGORYCONTROL_GREEN  = 142;
const int IDC_CATEGORYCONTROL_ORANGE = 143;
const int IDC_CATEGORYCONTROL_RED    = 144;

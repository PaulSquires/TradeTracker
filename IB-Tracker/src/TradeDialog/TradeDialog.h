...
const int IDC_TRADEDIALOG_LBLGRIDMAIN    = 113;
const int IDC_TRADEDIALOG_LBLGRIDROLL    = 114;

const int IDC_TRADEDIALOG_LBLTRANSDATE   = 115;
const int IDC_TRADEDIALOG_CMDTRANSDATE   = 116;

const int IDC_TRADEDIALOG_LBLCONTRACT    = 117;
const int IDC_TRADEDIALOG_LBLCONTRACTDATE= 118;
const int IDC_TRADEDIALOG_CMDCONTRACTDATE= 119;
